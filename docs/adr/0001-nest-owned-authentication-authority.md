...
| **Implemented** | [`apps/web/src/app/(catalog)/page.tsx`](../../apps/web/src/app/%28catalog%29/page.tsx) renders the public catalog through the generated client without session forwarding.                                                                          | The web app has no session-aware data access layer or protected route.                                        |
